...
$txt['down_module_last_files_title'] = '�ltimos Archivos';
$txt['down_module_stats_title'] = 'Estad�sticas del Modulo Descargas';
$txt['down_module_unapproved_title'] = 'Archivos no Aprobados';


//New Form
$txt['down_module_warning'] = '<strong>Nota:</strong> Tu envio no aparecer� instantaneamente - debes esperar a que el Administrador apruebe tu archivo antes de que aparezca en el Modulo Descargas.';
$txt['down_module_file_name'] = 'Nombre del Archivo';
$txt['down_module_file_description'] = 'Descripci�n';
$txt['down_module_image_description'] = 'Capturas';
$txt['down_module_file_small_description'] = 'Breve Descripci�n
								<br />Se usar� en la pagina de resultados de busqueda. 
								<br />100 caracteres como m�ximo. 
								<br />HTML y BBC no permitidos';
$txt['down_module_file_section'] = 'Secci�n a la que Pertenece';								
...
$txt['down_module_file_upload_max_size'] = 'Tama&ntilde;o M�ximo de Archivos permitido [SIZE] KB
...
$txt['down_file_warning_no_approved'] = 'Atenci�n: Este Archivo no ha sido aprobado.';
...
$txt['down_error_no_description'] = 'Error, no ha establecido la Descripci�n.';
$txt['down_error_no_small_description'] = 'Error, no ha establecido la breve Descripci�n.';
$txt['ultport_error_no_perms_groups'] = 'Error, no tiene los permisos necesarios para realizar esta acci�n, consulte con el Administrador de <em>'. $mbname .'</em>.';
$txt['down_error_no_section'] = 'Error, no ha sido creado las Secciones.';
$txt['down_error_no_action'] = 'Error, accion no permitida.';
$txt['down_error_no_found'] = 'Error, petici�n no encontrada.';
$txt['down_error_max_size'] = 'Tu archivo es demasiado grande. El tama&ntilde;o m�ximo permitido para archivos adjuntos es %d KB.';
$txt['down_error_canot_upload_file'] = 'No puede ser subido. Las Extensiones permitidas son: ';
$txt['down_error_no_files_section'] = 'No hay archivos en esta Secci�n';
