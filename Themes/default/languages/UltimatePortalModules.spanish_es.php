...
$txt['ultport_no_rows_title'] = 'Informaci�n.';
...
$txt['ultport_admin_up_limit'] = '<strong>Cantidad de Aportes por Pagina?</strong>
							<br />
							Aqui se establece el N�mero de Aportes por paginas, para mostrar dentro del bloque (p�gina de inicio).
...
$txt['ultport_admin_up_field_description'] = 'Descripci�n del Tema';
...
$txt['ultport_admin_extra_field_title'] = 'Descripci�n';
...
$txt['ultport_admin_add_extra_field_title'] = '<strong>Descripci�n</strong>
...
$txt['user_posts_perms'] = 'Administraci�n de Permisos';
...
$txt['ultport_admin_news_limit'] = '<strong>Limite de Visualizacion por pagina</strong>
							<br />
							Aqui se establece el N�mero de Noticias por paginas, para mostrar dentro del bloque (p�gina de inicio, por defecto 10 Noticias por Pagina)';					
...
$txt['ultport_admin_news_sect_position'] = 'Posici�n';
$txt['ultport_admin_news_sect_action'] = 'Acciones';
$txt['ultport_admin_add_sect_title'] = 'Agregando Nueva Secci�n';
$txt['ultport_admin_edit_sect_title'] = 'Editando Secci�n';
...
$txt['ultport_admin_news_add_sect_position'] = '<strong>Posici�n</strong>
...
$txt['ultport_admin_bn_limit'] = '<strong>Limite de Visualizacion</strong>
							<br />
							Aqui se establece el N�mero de Noticias para mostrar dentro del bloque 
							<br />(p�gina de inicio)';
$txt['ultport_admin_bn_lenght'] = '<strong>Maximo numero de Caracteres</strong>
							<br />
							Aqui se establece el Maximo N�mero de Caracteres que tendra cada Noticia visualizada. Para no establecer limite dejar vacio.';
...
$txt['up_down_settings_tab'] = 'Configuraci�n General';
$txt['up_down_section_tab'] = 'Administrar Secciones';

//Section Download Module - Description
$txt['up_down_settings_descrip'] = 'Area de Configuraci�n General del Modulo Descargas';
...
$txt['up_down_file_max_size'] = 'M�ximo Tama&ntilde;o del Archivo para subir en Kilobytes (0 = Ning�n L�mite). 
...
$txt['up_down_no_approved_file'] = 'No requiere de Aprobaci�n del Administrador';
$txt['up_down_yes_approved_file'] = 'Si requiere de Aprobaci�n del Administrador';
...
$txt['up_down_sect_perms'] = 'Grupos Permitidos para ver la Secci�n';
$txt['up_down_sect_board'] = 'Foro de la Seccion.';
$txt['up_down_sect_no_board'] = 'Desactivado';
$txt['up_down_sect_total_files'] = 'Cantidad de Archivos de la Secci�n';
...
$txt['up_down_manage_sect_perms'] = '<strong>Grupos Permitidos para ver la Secci�n</strong>
								<br />
...
$txt['up_down_manage_sect_description'] = '<strong>Descripci�n de la Secci�n</strong>
								<br />Una Breve descripci�n para la seccion creada. Solo acepta BBCode, NO HTML';					

//Internal Page Module
$txt['ipage_title'] = 'Paginas Internas';
$txt['ipage_settings_title'] = 'Configuraciones';
$txt['ipage_settings_description'] = 'Configuraci�n General del Modulo Paginas Internas.';
...
$txt['ultport_admin_aff_scrollDelay'] = '<strong>ScrollDelay</strong>
							<br />
							Define la velocidad del movimiento de las imagens. A menor numeraci�n, mayor velocidad
							<br />';
...
$txt['up_about_settings_tab'] = 'Configuraci�n General';
...
$txt['up_aboutus_settings_descrip'] = 'Area de Configuraci�n General del <strong>Modulo Quienes Somos</strong>';

//Section FAQ Module - Titles | Tabs
$txt['up_faq_title'] = 'Preguntas Frecuentes';
$txt['up_faq_config'] = 'Configuraci�n General';
...
$txt['up_faq_title_page'] = 'Titulo que tendra la Pagina Principal del Modulo
							<br/>No acepta BBCode';
$txt['up_faq_small_description'] = 'Breve Descripci�n de lo que se quiere presentar en la P�gina del <strong>Modulo Preguntas Frecuentes</strong>
							<br/>No acepta BBCode';
