...
$txt['ultport_read_more'] = 'Leer M�s';

//Titles Modules
$txt['up_module_title'] = 'Modulo';
$txt['up_module_ipage_title'] = 'P�ginas Internas';
$txt['up_ipage_add_html'] = 'Agregar P�gina en HTML';
$txt['up_ipage_add_bbc'] = 'Agregar P�gina en BBC';
$txt['up_ipage_date_created'] = 'Fecha de Creaci�n:';
$txt['up_ipage_member'] = 'Agregado por:';
$txt['up_ipage_date_updated'] = 'Fecha de Actualizaci�n:';
...
$txt['ipage_column_left'] = '<strong>Activar columna Izquierda para esta P�gina Interna?</strong>
						<br/>De esta forma, la columna Izquierda podra ser visualizada cuando se este dentro de esta P�gina Interna';
$txt['ipage_column_right'] = '<strong>Activar columna Derecha para esta P�gina Interna?</strong>
						<br/>De esta forma, la columna Derecha podra ser visualizada cuando se este dentro de esta P�gina Interna';
$txt['up_ipage_content'] = 'Contenido';						
$txt['up_ipage_perms'] = 'Quienes pueden ver esta P�gina Interna?';						
...
$txt['ultport_error_no_action'] = 'Error, acci� no permitida.';
